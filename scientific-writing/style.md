...
Sentence-scale rules encoding the user's voice. Apply from the first draft, not as a cleanup pass. SKILL.md's reader model and structure rules are assumed for paragraph-scale work.
